...
export const GridCardCar = ({title="default title", price="1.00 $", image="/hellcat.png", days="12", sold="0"}: GridCardProps) => {
    ...
    return (
        <div className="max-w-xs mx-4 mb-2 group rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div className="flex px-6 bg-baseLightBlue items-center">
                        <div
                            className="px flex w-full bg-[#aeafff] rounded-full h-1 items-center">
                            <div className="flex-0 bg-[#554aff] h-1 rounded-full" style={{width: `${sold}%`}}></div>
                            <span
